...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    // ** Why are some variables explicitly `public` and some are not?
    //Chainlink variables
    ...
    function startGame(uint8 _maxPlayers, uint256 _entryFee) public onlyOwner {
        ...
        // ** How gas-intensive is emptying arrays? Apparently you can get gas refunds for that??
        delete players;
     ...
     */
    // ** How is our contract paying the LINK gas instead of the last user who joined since
    // ** `getRandomWinner()` must've been triggered by the last user who wants to join?
